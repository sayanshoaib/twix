...
func (cu *CommentUpdate) SetTweetID(id int) *CommentUpdate {
	cu.mutation.SetTweetID(id)
	return cu
}

// SetNillableTweetID sets the "tweet" edge to the Tweet entity by ID if the given value is not nil.
func (cu *CommentUpdate) SetNillableTweetID(id *int) *CommentUpdate {
	if id != nil {
		cu = cu.SetTweetID(*id)
	}
	return cu
...
func (cu *CommentUpdate) SetTweet(t *Tweet) *CommentUpdate {
	return cu.SetTweetID(t.ID)
}
...
func (cu *CommentUpdate) ClearTweet() *CommentUpdate {
	cu.mutation.ClearTweet()
	return cu
}
...
func (cu *CommentUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cu.mutation.CommentID(); ok {
		_spec.SetField(comment.FieldCommentID, field.TypeUUID, value)
	}
	...
	if cu.mutation.TweetCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   comment.TweetTable,
			Columns: []string{comment.TweetColumn},
			Bidi:    false,
	...
	if nodes := cu.mutation.TweetIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   comment.TweetTable,
...
// SetTweetID sets the "tweet" edge to the Tweet entity by ID.
func (cuo *CommentUpdateOne) SetTweetID(id int) *CommentUpdateOne {
	cuo.mutation.SetTweetID(id)
	return cuo
}

// SetNillableTweetID sets the "tweet" edge to the Tweet entity by ID if the given value is not nil.
func (cuo *CommentUpdateOne) SetNillableTweetID(id *int) *CommentUpdateOne {
	if id != nil {
		cuo = cuo.SetTweetID(*id)
	}
	return cuo
}

// SetTweet sets the "tweet" edge to the Tweet entity.
func (cuo *CommentUpdateOne) SetTweet(t *Tweet) *CommentUpdateOne {
	return cuo.SetTweetID(t.ID)
}
...
// ClearTweet clears the "tweet" edge to the Tweet entity.
func (cuo *CommentUpdateOne) ClearTweet() *CommentUpdateOne {
	cuo.mutation.ClearTweet()
	return cuo
}
...
func (cuo *CommentUpdateOne) sqlSave(ctx context.Context) (_node *Comment, err error) {
	...
	if nodes := cuo.mutation.TweetIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   comment.TweetTable,
